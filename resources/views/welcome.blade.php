...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar bg-white navbar-light py-0 px-4 w-100">
                <a href="{{ url('/') }}" class="navbar-brand d-flex align-items-center text-center">
                    <div class="icon p-2 me-2">
                        <img class="img-fluid" src="{{ asset('assets/welcome/img/icon-deal.png') }}"
                            alt="Logo ARR MOTOR" style="width: 30px; height: 30px;">
                    </div>
                    <h1 class="m-0 text-dark">ARR MOTOR</h1>
                </a>
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('login') }}" class="btn btn-primary px-3 ms-4">Masuk</a>
                </div>
            </nav>
        </div>
        <!-- Navbar End -->
            ...
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                ...
                <div class="col-md-6 animated fadeIn">
                    <div class="owl-carousel header-carousel">
                        ...
                        <div class="owl-carousel-item">
                            <img class="img-fluid" src="{{ asset('assets/welcome/img/carousel-2.jpg') }}"
                                alt="">
                        </div>
                    </div>
                </div>
